...
<template>
  <header>
    ...
    <p>Check out <a href="https://www.ethanlam.dev/post/dynamic-table-of-contents-with-scroll-spy-effect-i">this post</a> or source code <a href="https://github.com/ethan-lamwah/vue3-scroll-spy-toc">here</a>, enjoys!</p>
  </header>
  <main>
    <section>
